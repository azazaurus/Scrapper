...
public class HLSParser {
    ...
    public List<String> parseFile(File file) throws IOException {
        ...
        if (!file.exists() || !file.isFile())
            throw new NullPointerException("The file \"" + file.getAbsolutePath() + "\" do NOT exist !");
    ...
    public List<String> parseUrl(String urlStr) throws IOException {
    ...
    private List<String> readSegmentsUrls(InputStream inputStream, String... partialUrl) throws IOException {
